...
public class PlayerControl : MonoBehaviour
{
    ...
    {
		if(col.tag == "EnemyShipTag" || col.tag == "EnemyBulletTag" || col.tag == "Boss1" || col.tag == "Boss2" || col.tag == "Boss3")
        {
			PlayExplosion();
			lives--;
			LivesUIText.text = lives.ToString();
	...
	public void ShootAction1()
	{
		...
		GetComponent<AudioSource>().Play();
		GameObject bullet01 = (GameObject)Instantiate(PlayerBulletGo1);
		bullet01.transform.position = bulletPosition1.transform.position;

		GameObject bullet02 = (GameObject)Instantiate(PlayerBulletGo1);
		bullet02.transform.position = bulletPosition2.transform.position;
	...
	public void ShootAction2()
	{
		...
		GetComponent<AudioSource>().Play();
		GameObject bullet01 = (GameObject)Instantiate(PlayerBulletGo2);
		bullet01.transform.position = bulletPosition1.transform.position;
